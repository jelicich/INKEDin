...
<form method="post" action="/photo/upload_photo" id="profile-cover-form" enctype="multipart/form-data">
	<div class="row">
		<div class="col-md-3 edit-profile-pic">
			<img src="<?php echo $user['cover_path'] ?>" id="display-current-cover" alt="Foto de portada"/>
		</div>
		<div class="col-md-9 input-container">
			<div class="input-container-inner">
				<label for="cover-input-file">Seleccionar foto de portada</label>
				<input type="file" name="upl" id="cover-input-file" onchange="inked.Photo.validateForm(event)"/>
				<button class="btn btn-default btn-lg disabled" id="save-cover-pic-btn" onclick="inked.Photo.uploadPhoto(event)" data-target="cover">Guardar</button>
			</div>							
		</div>
